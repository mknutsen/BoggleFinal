...
public class Boggle {
    ...
    private final String[] dice = {
            "AAAFRS", "AEEGMU", "CEIILT", "DHLNOR", "FIPRSY", "AAEEEE", "AEGMNN", "CEILPT", "DDLNOR", "GORRVW",
            "AAFIRS", "AFIRSY", "CEIPST", "EIIITT", "HIPRRY", "ADENNN", "BJKQXZ", "DHHNOT", "EMOTTT", "NOOTUW",
    ...
    /**
     * Constructor for Boggle Creates new Boggle board 5x5 array of strings and randomizes it
     */
    public Boggle() {
    ...
    /**
     * @param dictionary
     *         the mknutsen.boggle.dictionary to set
     */
    ...
    /**
     * checks to see if the word is in the mknutsen.boggle.dictionary
     *
     * @param str
     *         string to check
     * @return if word is in the mknutsen.boggle.dictionary
     */
