...
import mknutsen.boggle.dictionary.DictionaryTrie;
import mknutsen.boggle.dictionary.TrieNode;
...
public class BoggleGraphElegant extends BoggleGraph {
	private DictionaryTrie trie = new DictionaryTrie(("mknutsen/boggle/dictionary.txt"));
	/**
	 * @param boggin
	 */
